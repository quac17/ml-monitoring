...
Generate synthetic sklearn Wine–schema features with configurable drift (see config.yaml).
"""
...
class WineDataGenerator:
    """Generate synthetic feature vectors aligned with sklearn load_wine."""
